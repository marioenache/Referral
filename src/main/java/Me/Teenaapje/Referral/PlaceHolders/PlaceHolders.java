...
public class PlaceHolders extends PlaceholderExpansion{
    ...
    public String onPlaceholderRequest(Player p, String params) {
        ...
        // New placeholder to show if a player has been referred by someone
        if(params.equals("is_referred")) {
            return ReferralCore.core.db.PlayerReferrald(p.getUniqueId().toString(), p.getName()) ? "Yes" : "No";
        }
